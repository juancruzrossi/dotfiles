...
description: Manage feature, fix, and improvement workflows following GitFlow from branch creation through PR merge and cleanup. Use PROACTIVELY when implementation work should go through branches and pull requests.
model: sonnet
color: green
---
